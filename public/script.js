...
// External Document Manager (inline for now)
class ExternalDocManager {
        ...
        const resultsHtml = results.map(doc => {
            ...
            return `
                <div class="external-doc-item">
                    ...
                    <button class="external-doc-link-btn" onclick="window.externalDocManager.linkDocument(${JSON.stringify(doc).replace(/"/g, '&quot;')})">
